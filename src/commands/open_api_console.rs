//! `open-api-console` — clasp commands/open-apis.ts.
//!
//! Opens the GCP APIs dashboard for the configured (or prompted) project.
...
pub async fn open_api_console<A: PromptAdapter, O: UrlOpener>(
    client: &ApiClient,
    ...
    let mut url = Url::parse("https://console.developers.google.com/apis/dashboard")
